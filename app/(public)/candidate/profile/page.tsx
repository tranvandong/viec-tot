                    ...
                    {editing === `experience-${experience.id}` ? (
                      <div className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="space-y-2">
                            <Label htmlFor={`exp-title-${experience.id}`}>
                              Chức danh
                            </Label>
                            <Input
                          ...
                          <div className="space-y-2">
                            <Label htmlFor={`exp-from-${experience.id}`}>
                              Từ
                            </Label>
                            <Input
                          ...
                          {!experience.current && (
                            <div className="space-y-2">
                              <Label htmlFor={`exp-to-${experience.id}`}>
                                Đến
                              </Label>
                              <Input
                        ...
                        <div className="space-y-2">
                          <Label htmlFor={`exp-description-${experience.id}`}>
                            Mô tả
                          </Label>
                          <Textarea
                      ...
                      <div className="relative">
                        <Button
                          ...
                          onClick={() =>
                            handleEditToggle(`experience-${experience.id}`)
                          }
                        >
                          <Edit className="h-4 w-4" />
                        </Button>
                    ...
                    {editing === `education-${edu.id}` ? (
                      ...
                      <div className="relative">
                        <Button
                          ...
                          className="absolute top-0 right-0"
                          onClick={() =>
                            handleEditToggle(`education-${edu.id}`)
                          }
                        >
                          <Edit className="h-4 w-4" />
                        </Button>
                    ...
                    {editing === `certification-${cert.id}` ? (
                      <div className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="space-y-2">
                            <Label htmlFor={`cert-expires-${cert.id}`}>
                              Ngày hết hạn
                            </Label>
                            <Input
                              ...
                              onChange={(e) => {
                                ...
                                newCertifications[index].expires =
                                  e.target.value;
                                setProfile({
                                  ...profile,
                                  certifications: newCertifications,
                        ...
                        <div className="space-y-2">
                          ...
                          <Textarea
                            ...
                            onChange={(e) => {
                              ...
                              newCertifications[index].description =
                                e.target.value;
                              setProfile({
                                ...profile,
                                certifications: newCertifications,
                      ...
                      <div className="relative">
                        <Button
                          ...
                          className="absolute top-0 right-0"
                          onClick={() =>
                            handleEditToggle(`certification-${cert.id}`)
                          }
                        >
                          <Edit className="h-4 w-4" />
                        </Button>
