    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="bg-blue-950 text-white pt-8 pb-24">
        <div className="container text-center max-w-3xl mx-auto px-4 md:px-8">
          <div className="inline-block bg-blue-900/50 text-xs px-4 py-2 rounded-full mb-8">Nền tảng tìm việc số 1</div>
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="md:w-64 bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 h-fit">
            ...
            <div className="mb-6 border-b dark:border-gray-700 pb-6">
              ...
              >
                <h4 className="font-medium text-gray-800 dark:text-white">Loại công việc</h4>
              ...
              {expandedSections.jobType && (
                <div className="space-y-3">
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="contract" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                      Hợp đồng
                    </label>
                  </div>
                  <div className="flex items-center">
                    <input
                      ...
                      defaultChecked
                    />
                    <label htmlFor="full-time" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                      Toàn thời gian
                    </label>
                  </div>
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded dark:border-gray-600 dark:bg-gray-700"
                    />
                    <label htmlFor="part-time" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                      Bán thời gian
                    </label>
                  </div>
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded dark:border-gray-600 dark:bg-gray-700"
                    />
                    <label htmlFor="internship" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                      Thực tập
                    </label>
                  </div>
                </div>
            ...
            <div className="mb-6 border-b dark:border-gray-700 pb-6">
              <div className="flex justify-between items-center">
                <h4 className="font-medium text-gray-800 dark:text-white">Chấp nhận làm từ xa</h4>
                <button
                  className={`w-12 h-6 rounded-full p-1 transition-colors duration-200 ease-in-out ${
                    isRemoteOpen ? "bg-blue-500" : "bg-gray-300 dark:bg-gray-600"
                  }`}
            ...
            <div className="mb-6 border-b dark:border-gray-700 pb-6">
              ...
              >
                <h4 className="font-medium text-gray-800 dark:text-white">Mức lương</h4>
                ...
                <>
                  <div className="space-y-3 mb-4">
                    <div className="flex items-center">
                      <input
                        ...
                        className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded dark:border-gray-600 dark:bg-gray-700"
                      />
                      <label htmlFor="less-than-1000" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                        Dưới 1.000$
                      </label>
                    </div>
                    <div className="flex items-center">
                      <input
                        ...
                        className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded dark:border-gray-600 dark:bg-gray-700"
                      />
                      <label htmlFor="1000-15000" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                        1.000$ - 15.000$
                      </label>
                    </div>
                    <div className="flex items-center">
                      <input
                        ...
                        className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded dark:border-gray-600 dark:bg-gray-700"
                      />
                      <label htmlFor="more-than-15000" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                        Trên 15.000$
                      </label>
                    </div>
                    <div className="flex items-center">
                      <input
                        ...
                        defaultChecked
                      />
                      <label htmlFor="custom" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                        Tùy chỉnh
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="mt-6">
                    ...
                    <div className="flex justify-between mt-2">
                      ...
                      <span className="text-sm text-gray-600 dark:text-gray-400">25.000$</span>
                    </div>
                  </div>
                </>
              )}
            ...
            <div className="mb-6">
              ...
              >
                <h4 className="font-medium text-gray-800 dark:text-white">Kinh nghiệm</h4>
                ...
                <div className="space-y-3">
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded dark:border-gray-600 dark:bg-gray-700"
                    />
                    <label htmlFor="less-than-year" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                      Dưới 1 năm
                    </label>
                  </div>
                  <div className="flex items-center">
                    <input
                      ...
                      defaultChecked
                    />
                    <label htmlFor="1-3-years" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                      1-3 năm
                    </label>
                  </div>
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded dark:border-gray-600 dark:bg-gray-700"
                    />
                    <label htmlFor="3-5-years" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                      3-5 năm
                    </label>
                  </div>
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded dark:border-gray-600 dark:bg-gray-700"
                    />
                    <label htmlFor="5-10-years" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                      5-10 năm
                    </label>
                  </div>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-6">
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm text-gray-600 dark:text-gray-300">Sắp xếp theo</span>
                  ...
                  <div className="flex border border-gray-300 dark:border-gray-600 rounded-md">
                    <button
                      className={`px-2 py-1.5 ${viewMode === "grid" ? "bg-gray-100 dark:bg-gray-700" : ""}`}
                    ...
                    <button
                      className={`px-2 py-1.5 ${viewMode === "list" ? "bg-gray-100 dark:bg-gray-700" : ""}`}
                  ...
                  {jobs.map((job) => (
                    ...
                    >
                      <div className="p-5">
                        ...
                        {job.match && (
                          <div className="text-sm text-gray-500 dark:text-gray-400 mb-3">Phù hợp với hồ sơ của bạn</div>
                        )}
      ...
      {selectedJob && (
        <JobDetailModal
          job={{
            ...
            jobType: selectedJob.jobType === "Fulltime" ? "Toàn thời gian" : selectedJob.jobType,
            workType:
            ...
            benefits: selectedJob.benefits.map((benefit) => {
              if (benefit === "Competitive salary and benefits package") return "Mức lương và phúc lợi cạnh tranh"
              if (benefit === "Flexible working hours") return "Giờ làm việc linh hoạt"
              if (benefit === "Remote work options") return "Tùy chọn làm việc từ xa"
              if (benefit === "Professional development opportunities") return "Cơ hội phát triển chuyên môn"
              if (benefit === "Opportunity to work on a product used by millions")
                return "Cơ hội làm việc với sản phẩm được hàng triệu người sử dụng"
              if (benefit === "Career growth and development opportunities") return "Cơ hội phát triển sự nghiệp"
              ...
              if (benefit === "Professional development budget") return "Ngân sách phát triển chuyên môn"
              if (benefit === "Modern office with great amenities") return "Văn phòng hiện đại với tiện nghi tuyệt vời"
              if (benefit === "Leadership opportunities") return "Cơ hội lãnh đạo"
              return benefit
            }),
          }}
          isOpen={isModalOpen}
          ...
          similarJobs={getSimilarJobs(selectedJob).map((job) => ({
            ...
            jobType: job.jobType === "Fulltime" ? "Toàn thời gian" : job.jobType,
            workType: job.workType === "Remote" ? "Từ xa" : job.workType === "Onsite" ? "Tại văn phòng" : "Kết hợp",
          ...
          otherJobsFromCompany={getOtherJobsFromCompany(selectedJob).map((job) => ({
            ...job,
            title: job.title,
            company: job.company,
            location: job.location,
