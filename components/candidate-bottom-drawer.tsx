...
export function CandidateBottomDrawer({ candidate, isOpen, onClose }: CandidateBottomDrawerProps) {
      ...
      >
        ...
        <div className="p-6">
          ...
          <Tabs defaultValue="profile" className="w-full">
            ...
            <TabsContent value="profile" className="space-y-4">
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{candidate.birthDate}</p>
                  </div>
                  <div>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Vị trí mong muốn</p>
                    <p className="font-medium">{candidate.desiredPosition}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Mức lương mong muốn</p>
                    <p className="font-medium">{candidate.expectedSalary}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Loại công việc</p>
                    <p className="font-medium">{candidate.jobType}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Sẵn sàng làm việc</p>
          ...
          <div className="flex justify-end gap-3 mt-8 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <button className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Liên hệ ứng viên</button>
          </div>
        </div>
      </div>
    </div>
